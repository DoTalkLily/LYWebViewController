...
#import "AWEUIWebViewController.h"
#import <StoreKit/StoreKit.h>
#import "AWEWebViewControllerActivity.h"

@interface AWEUIWebViewController ()
{
    BOOL _loading;
    NSURL *_baseURL;
...
@implementation AWEUIWebViewController
...
{
    if ([self.navigationController.topViewController isKindOfClass:[AWEUIWebViewController class]]){
        AWEUIWebViewController* webVC = (AWEUIWebViewController*)self.navigationController.topViewController;
...
- (UIBarButtonItem *)backBarButtonItem {
    ...
    UIImage *image = [UIImage imageNamed:@"AWEWebViewController.bundle/AWEWebViewControllerBack"];
...
- (UIBarButtonItem *)forwardBarButtonItem
{
    ...
    UIImage *image = [UIImage imageNamed:@"AWEWebViewController.bundle/AWEWebViewControllerNext"];
...
{
    if ([request.URL.absoluteString isEqualToString:kAWE404NotFoundURLKey] ||
        [request.URL.absoluteString isEqualToString:kAWENetworkErrorURLKey]) {
        [self loadURL:_URL];
        return NO;
    }
